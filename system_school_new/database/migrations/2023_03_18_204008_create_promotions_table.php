...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('promotions', function (Blueprint $table) {
            ...
            $table->string('acadmic_year_new');
            $table->timestamps();
        });
        Schema::table('promotions', function (Blueprint $table) {
            $table->foreign('student_id')->references('id')->on('students')->onDelete('cascade');
            $table->foreign('from_grade')->references('id')->on('grates')->onDelete('cascade');
            $table->foreign('from_classroom')->references('id')->on('classroms')->onDelete('cascade');
            $table->foreign('from_section')->references('id')->on('sections')->onDelete('cascade');
            $table->foreign('to_grade')->references('id')->on('grates')->onDelete('cascade');
            $table->foreign('to_classroom')->references('id')->on('classroms')->onDelete('cascade');
