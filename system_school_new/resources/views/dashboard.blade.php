                    ...
                    <div class="card card-statistics h-100">
                        <div class="card-body">
                            ...
                            <p class="text-muted pt-3 mb-0 mt-2 border-top">
                                <i class="fa fa-exclamation-circle mr-1" aria-hidden="true"></i> <a class="btn" style="color:red;" href="{{route('students.index')}}" style="color:red;">{{trans('Students_trans.show_data')}}</a>
                            </p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card card-statistics h-100">
                        <div class="card-body">
                            <div class="clearfix">
                                ...
                                <div class="float-right text-right">
                                    <p class="card-text text-dark">{{trans('Teacher_trans.number_teacher')}}</p>
                                    <h4>{{App\Models\teacher::count()}}</h4>
                                </div>
                            </div>
                            <p class="text-muted pt-3 mb-0 mt-2 border-top">
                                <i class="fa fa-bookmark-o mr-1" aria-hidden="true"></i><a href="{{route('teachers-for-school.index')}}" style="color:red;"> {{trans('Students_trans.show_data')}}</a>
                            </p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card card-statistics h-100">
                        <div class="card-body">
                            <div class="clearfix">
                                ...
                                <div class="float-right text-right">
                                    <p class="card-text text-dark">{{trans('Sections_trans.number_parent')}}</p>
                                    <h4>{{App\Models\My_parnt::count()}}</h4>
                                </div>
                            </div>
                            <p class="text-muted pt-3 mb-0 mt-2 border-top">
                                <i class="fa fa-calendar mr-1" aria-hidden="true"></i>  <a href="{{route('add_parent')}}" style="color:red;">{{trans('Students_trans.show_data')}}</a>
                            </p>
                        </div>
                    </div>
                </div>
                <div class="col-xl-3 col-lg-6 col-md-6 mb-30">
                    <div class="card card-statistics h-100">
                        <div class="card-body">
                            ...
                            <p class="text-muted pt-3 mb-0 mt-2 border-top">
                                <i class="fa fa-repeat mr-1" aria-hidden="true"></i>  <a href="{{route('showsection.index')}}" style="color:red;">{{trans('Students_trans.show_data')}}</a>
                            </p>
                        </div>
                    </div>
                </div>
