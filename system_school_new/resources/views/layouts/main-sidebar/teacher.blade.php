<div class="scrollbar side-menu-bg" style="overflow: scroll">
    <ul class="nav navbar-nav side-menu" id="sidebarnav">
        ...
        <!-- menu title -->
        <li class="mt-10 mb-10 text-muted pl-4 font-medium menu-title">{{trans('main_sidebar.hello')}}{{auth('teacher')->user()->Name}} </li>
        ...
        <!-- الطلاب-->
        <li>
            <a href="{{route('student-teacher.index')}}"><i class="fas fa-user-graduate"></i><span
      ...
      <li>
         ...
         <li>
            ...
            <ul id="sections-menu" class="collapse" data-parent="#sidebarnav">
                <li><a href="{{route('student-teacher.create')}}">تقرير الحضور والغياب</a></li>
