...
<div class="btn-group mb-1">
    <button type="button" class="btn btn-primary btn-sm dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">{{trans('main_sidebar.langoudage')}}</button> 
                    
                <div class="dropdown-menu dropdown-menu-right dropdown-big dropdown-notifications">
               
                
    @foreach(LaravelLocalization::getSupportedLocales() as $localeCode => $properties)
        <li calss="dropdown-item">
    ...
    @endforeach
                ...
                <li class="nav-item dropdown mr-30">
                    ...
                    <div class="dropdown-menu dropdown-menu-right">
                        ...
                        <!-- <a class="dropdown-item" href="#"><i class="text-danger ti-unlock"></i></a -->
                        <!-- logout  -->
                        @if(auth('student')->check())
                        <form action="{{route('logout','student')}}" method="GET">
                        @elseif(auth('parnt')->check())
                        <form action="{{route('logout','parnt')}}" method="GET">
