...
@section('css')
    @toastr_css
@section('title')
    {{trans('main_sidebar.List_Teachers')}}
@stop
@endsection
@section('page-header')
    <!-- breadcrumb -->
            ...
            <div class="card card-statistics h-100">
                <div class="card-body">
                    <div class="col-xl-12 mb-30">
                        <div class="card card-statistics h-100">
                            <div class="card-body">
                                <a href="teachers-for-school/create" class="btn btn-success btn-sm" role="button"
                                    ...
                                    <table id="datatable" class="table  table-hover table-sm table-bordered p-0"
                                        ...
                                        @foreach($Teachers as $Teacher)
                                            ...
                                            <td>{{$Teacher->specializations->Name}}</td>
                                                <td>
                                                    <a href="{{route('teachers-for-school.edit',$Teacher->id)}}" class="btn btn-info btn-sm" role="button" aria-pressed="true"><i class="fa fa-edit"></i></a>
                                            ...
                                            <div class="modal fade" id="delete_Teacher{{$Teacher->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                <div class="modal-dialog" role="document">
                                                    <form action="{{route('teachers-for-school.destroy','y')}}" method="post">
                                                        {{method_field('delete')}}
                                                        {{csrf_field()}}
