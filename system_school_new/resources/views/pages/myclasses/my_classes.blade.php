            ...
            <div class="card-body">
                ...
                <div class="table-responsive">
                    <table id="datatable" class="table  table-hover table-sm table-bordered p-0" data-page-length="50" style="text-align: center">
                        <thead>
                            <tr>
                                <th><input name="select_all" id="example-select-all" type="checkbox" onclick="CheckAll('form-check-input', this)" /></th>
                                <th>#</th>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" value="{{$My_Class->id}}" id="flexCheckDefault">
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <form action="{{route('calsses-student.update','test')}}" method="post">
                                                {{ method_field('patch') }}
                                                @csrf
                                                <div class="row">
                                                    <div class="col">
                                                        <label for="Name" class="mr-sm-2">{{ trans('My_Classes_trans.Name_class') }}
                                                            :</label>
                                                        <input id="Name" type="text" name="Name_ar" class="form-control" value="{{ $My_Class->getTranslation('Name_Class', 'ar') }}" required>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control form-control-lg" id="exampleFormControlSelect1" name="Grade_id">
                                                        <option value="{{ $My_Class->grateName->id }}">
                                                            {{ $My_Class->grateName->Name }}
                                                        </option>
                                                        @foreach ($Grades as $Grade)
                            ...
                            <div class="modal fade" id="delete{{ $My_Class->id }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form action="{{route('calsses-student.destroy',0)}}" method="post">
                                                {{ method_field('Delete') }}
                                                @csrf
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form class=" row mb-30" action="{{route('calsses-student.store')}}" method="POST">
                        @csrf
...
<script>
    function CheckAll(className, el) {
        let chek = document.getElementsByClassName(className);
        if (el.checked) {
